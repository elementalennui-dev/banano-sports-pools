...
$(document).ready(function() {
    ...
    $("#nfl_week, #nfl_season").on("change", function(x) {
        $("#nfl_games").hide();
        $(".progress-bar").animate({
            width: "0%",
        }, 0);
...
// gets the current NFL Week, then populates games
function getNFLWeek() {
...
// main function to get the active NFL games for that week
function getNFLGames() {
    ...
    $.ajax({
        type: "GET",
        url: `/nfl/get_nfl_data/${nfl_week}/${nfl_season}`,
        contentType: "application/json; charset=utf-8",
                                    ...
                                    <tbody>
                                        <tr class="${team2_rec}">
                                            <td class="text-center align-middle">
                                                <p><img src="https://secure.espn.com/combiner/i?img=/i/teamlogos/nfl/500/scoreboard/${x.team2.toLowerCase()}.png&w=48&h=48"><strong> ${x.team2}</strong></p>
                                            </td>
                                            <td>
                                                <table style="font-size: 0.7rem;" class="table-bordered table-striped table-hover table">
                                                    <tr>
                                                        <th class="text-center align-middle">Vegas</th>
                                        ...
                                        <tr class="${team1_rec}">
                                            <td class="text-center align-middle">
                                                <p><img src="https://secure.espn.com/combiner/i?img=/i/teamlogos/nfl/500/scoreboard/${x.team1.toLowerCase()}.png&w=48&h=48"><strong> ${x.team1}</strong></p>
                                            </td>
                                            <td>
                                                <table style="font-size: 0.7rem;" class="table-bordered table-striped table-hover table">
                                                    <tr>
