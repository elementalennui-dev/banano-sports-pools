...
$(document).ready(function() {
    ...
    $("#nfl_week,#nfl_season").on("change", function() {
        getBanAddresses();
    });
...
// gets the current NFL Week, then populates leaderboard
function getNFLWeek() {
...
function getLeaderboards() {
    ...
    $.ajax({
        type: "POST",
        url: "/nfl/get_nfl_leaderboards",
        contentType: 'application/json;charset=UTF-8',
        data: JSON.stringify({ "data": payload }),
        success: function(returnedData) {
            // print it
            // console.log(returnedData);
            renderLeaderboards(returnedData, ban_address);
...
function renderLeaderboards(inp_data, ban_address) {
    // init html string
    let html = "";
    ...
    if (ban_address !== "") {
        ...
        $('#indiv_table').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'excelHtml5',
                    title: function() { return `${ban_address_verified}_banano_sports_indiv_leaderboard`; },
                },
                {
                    extend: 'csvHtml5',
                    title: function() { return `${ban_address_verified}_banano_sports_indiv_leaderboard`; },
        ...
        $('#sql_table').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'excelHtml5',
                    title: function() { return `${ban_address_verified}_banano_sports_leaderboard`; },
                },
                {
                    extend: 'csvHtml5',
                    title: function() { return `${ban_address_verified}_banano_sports_leaderboard`; },
